                    ...
                    if (data.get(newKey("isshop"), PersistentDataType.INTEGER).equals(1)) {
                        ...
                        try {
                            ...
                            if (!resultSet.next()) {
                                ...
                                storage_loc_encoded = resultSet.getString("storage_location_encoded");
                                itemstack = resultSet.getString("itemstack");
                                shop_type = resultSet.getString("shop_type");
                        ...
                        if (owner.equals(event.getPlayer().getName())) {
                            ...
                            if (shop_type.toLowerCase().equals("prodej")) {
                                ...
                                int counteight = count * 8;
                                double priceeight = price * 8;
                                if (counteight <= items_in_storage) {
                                    userui.setItem(1, newItem("&aKoupit &2" + Integer.toString(counteight) + "ks&a za &2" + priceeight + "$", Material.LIME_WOOL, buyeight));
                                } else {
                                    //Integer counteight = count * 8;
                                    buyeight.add(ChatColor.RED + "Nedostatek itemů ve skladišti");
                                    userui.setItem(1, newItem("&aKoupit &2" + Integer.toString(counteight) + "ks&a za &2" + priceeight + "$", Material.LIME_STAINED_GLASS, buyeight));
                                }
                            } else {
                                ArrayList<String> buyone = new ArrayList<>();
                                ArrayList<String> buyeight = new ArrayList<>();
                                ...
                                double priceeight = price * 8;
                                if (counteight <= items_in_storage) {
                                    userui.setItem(1, newItem("&aProdat &2" + Integer.toString(counteight) + "ks&a za &2" + priceeight + "$", Material.YELLOW_WOOL, buyeight));
                                } else {
                                    //Integer counteight = count * 8;
                                    buyeight.add(ChatColor.RED + "Nedostatek místa ve skladišti");
                                    userui.setItem(1, newItem("&aProdat &2" + Integer.toString(counteight) + "ks&a za &2" + priceeight + "$", Material.YELLOW_STAINED_GLASS, buyeight));
                                }
                            }
